...
YOU HAVE EXACTLY 7 TRANSMISSIONS. INTERROGATE THE NODES, LOG YOUR OBSERVATIONS, AND MARK EACH MIND AS EITHER HUMAN OR AI. 
...
AS THE TRANSMISSIONS DECREASE, THE SUN WILL SET, AND SHADOWS WILL STRETCH. TRUST NOTHING BUT THE SHADOW OF THEIR WORDS.`;
  ...
  useEffect(() => {
    if (screen === 'chat') {
      const intensity = 1 - (questionsLeft / 7);
